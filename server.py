...
def create_app():
    ...
    class ExpertForm(FlaskForm):
        ...
        great_trades_threshold = IntegerField("Threshold Trades ueber 10%",default=6)
        ...
        bad_trades_multiplier = IntegerField("Multiplier Negative Trades",default=100)
        severe_trades_multiplier = IntegerField("Multiplier Trades unter -10%",default=100)
        great_trades_multiplier = IntegerField("Multiplier Trades ueber 10%",default=100)
        submit = SubmitField()
